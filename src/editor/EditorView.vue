<template>
  <div class="max-w-2xl mx-auto p-4">
    ...
    <button
      type="button"
      class="mb-4 px-3 py-1 bg-green-600 text-white rounded"
    ...
    <form class="space-y-4" @submit.prevent="handleExport">
        ...
        >
          ...
          >
            <div class="flex gap-2 mb-2">
              ...
              <button
                type="button"
                class="px-2 py-1 bg-red-400 text-white rounded text-xs"
      ...
      <div v-if="validationError" class="mt-2 text-red-600 text-sm whitespace-pre-line">
        {{ validationError }}
      </div>
    </form>
