<template>
  <div class="p-4 max-w-full mx-auto">
    ...
    <div v-else>
      ...
      <!-- 滑動提示 (僅在手機版顯示) -->
      <div class="mobile-scroll-hint md:hidden bg-blue-50 text-blue-700 text-sm px-3 py-2 rounded-lg mb-4 flex items-center gap-2">
      ...
      <div class="timeline-scroll-container">
        ...
        <div v-for="timeSlot in currentDayTimeSlots" :key="timeSlot.time" class="timeline-row">
          ...
          <div v-for="stage in festival.stages" :key="stage.id" class="performance-cell">
            <div 
              v-for="perf in getPerformanceAt(stage, timeSlot.timestamp)" 
              :key="perf.artist + perf.start"
              class="performance-block"
              :style="getPerformanceStyle(perf, timeSlot.timestamp)"
...
@media (max-width: 768px) {
  .timeline-container {
    font-size: 0.75rem;
    min-width: 1000px; /* 手機版增加最小寬度確保滑動空間 */
  }
